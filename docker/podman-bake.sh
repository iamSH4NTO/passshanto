...
LABEL_ARGS=(
    ...
    --label org.opencontainers.image.documentation="https://github.com/iamsh4nto/passshanto/wiki"
    --label org.opencontainers.image.url="https://github.com/iamsh4nto/passshanto"
